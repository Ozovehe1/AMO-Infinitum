    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .nav-read-mobile { display: inline-flex !important; }
        }
        @media (min-width: 641px) {
          .nav-read-mobile { display: none !important; }
        }
      `}</style>
      ...
      <div style={{ minHeight: "100vh", background: "#0d1f3c", color: "#fffef9" }}>
        ...
        <nav style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 1.5rem", width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.25rem" }}>
              {/* Read posts button — primary nav action for visitors */}
              <a href="#posts" className="nav-read-btn" style={{
        ...
        <section style={{ minHeight: "92vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "relative", zIndex: 2, maxWidth: 1200, margin: "0 auto", width: "100%", padding: "0 1.5rem 6rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "2.5rem", flexWrap: "wrap" }}>
              ...
              <a href="#posts" style={{ color: "rgba(255,254,249,0.45)", fontFamily: "Inter, sans-serif", fontSize: "0.82rem", textDecoration: "none" }}>
        ...
        {/* Discovery feed */}
        <section id="posts" style={{ background: "#f7f6f3", padding: "5rem 1.5rem" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            {posts.length === 0 ? (
              <p style={{ textAlign: "center", padding: "5rem 0", color: "rgba(13,31,60,0.35)", fontFamily: "'Playfair Display', serif", fontSize: "1.2rem" }}>
        ...
        <footer style={{ background: "#0d1f3c", padding: "4rem 1.5rem", borderTop: "1px solid rgba(200,169,126,0.07)" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
              <a href="#posts" style={{ color: "rgba(255,254,249,0.25)", fontFamily: "Inter, sans-serif", fontSize: "0.78rem", textDecoration: "none" }}>Browse posts</a>
