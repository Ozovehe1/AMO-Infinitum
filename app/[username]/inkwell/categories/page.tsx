          ...
          {creating && (
            <div style={{ background: "#fffef9", border: "1px solid color-mix(in srgb, var(--admin-primary) 12%, transparent)", borderRadius: 10, padding: "1.75rem", marginBottom: "1.5rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div><label style={labelStyle}>Name</label><input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} placeholder="e.g. Philosophy, Life…" style={inputStyle} autoFocus /></div>
                <div><label style={labelStyle}>Description (optional)</label><input value={form.description} onChange={e => setForm(f => ({ ...f, description: e.target.value }))} placeholder="Short description" style={inputStyle} /></div>
                <div>
