      ...
      <main style={{ paddingTop: 64, background: "#fffef9", flex: 1 }}>
        ...
        <div style={{ background: primary, padding: "5rem 1.5rem" }}>
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 600, color: "#fffef9", lineHeight: 1.15, margin: "0 0 1.75rem" }}>
              {theme.siteName}
            </h1>
            {theme.aboutHeroSubtitle && (
              <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "1.15rem", color: "rgba(255,254,249,0.72)", lineHeight: 1.75, margin: 0, maxWidth: 560, fontStyle: "italic" }}>
                {theme.aboutHeroSubtitle}
              </p>
            )}
          </div>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "5rem 1.5rem" }}>
          {theme.aboutBody ? (
            ...
            <p style={{ fontFamily: "'Source Serif 4', serif", fontSize: "1.05rem", color: "#3a5068", lineHeight: 1.8 }}>
