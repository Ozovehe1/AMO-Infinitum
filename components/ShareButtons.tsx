  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "2rem 1.5rem" }}>
      ...
      <div style={{
        ...
        <span style={{
          flex: 1, fontFamily: "Inter, sans-serif", fontSize: "0.8rem",
          color: "#3a5068", wordBreak: "break-all", lineHeight: 1.5,
        }}>{url}</span>
        <button
          onClick={copy}
          style={{
      ...
      <div style={{ display: "flex", gap: "0.625rem", flexWrap: "wrap" }}>
        ...
        <a
          ...
          style={{
            ...
            border: "1px solid rgba(13,31,60,0.2)", borderRadius: 6,
            padding: "0.5rem 1rem",
            fontFamily: "Inter, sans-serif", fontSize: "0.8rem", fontWeight: 500,
            textDecoration: "none",
          }}
