    ...
    <>
      ...
      <div className="mobile-write-wrap" style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", background: "#fff" }}>
          ...
          {/* Grammar panel — shown below toolbar when grammarOn */}
          {grammarOn && !mobileUrlMode && (
            <div style={{ background: "#f8fffe", borderBottom: "1px solid rgba(0,0,0,0.07)", flexShrink: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px" }}>
                ...
                {grammarLoading && <span style={{ fontFamily: "Inter, sans-serif", fontSize: "0.72rem", color: "#8fa3b1" }}>Checking…</span>}
                {grammarError && !grammarLoading && (
                  <span style={{ fontFamily: "Inter, sans-serif", fontSize: "0.72rem", color: "#c0392b" }}>⚠ {grammarError}</span>
                )}
                ...
                <button onPointerDown={e => { e.preventDefault(); checkMobileGrammar(); }} disabled={grammarLoading}
                  style={{ height: 28, padding: "0 10px", background: "transparent", color: "#4a9e7a", border: "1px solid #4a9e7a", borderRadius: 5, cursor: grammarLoading ? "default" : "pointer", fontSize: "0.72rem", fontFamily: "Inter, sans-serif", fontWeight: 600, opacity: grammarLoading ? 0.5 : 1, flexShrink: 0 }}>
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 2000, background: "rgba(13,31,60,0.65)", display: "flex", alignItems: "flex-end", justifyContent: "center" }}
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: "#fffef9", borderRadius: "20px 20px 0 0", overflow: "hidden", width: "100%", maxWidth: 480, maxHeight: "92vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
          ...
          {/* Inline CSS preview card — full cover image, gradient at bottom only */}
            ...
            <div style={{ width: "100%", background: "#0d1f3c", position: "relative", overflow: "hidden",
              ...
              <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "clamp(18px, 5%, 40px) clamp(20px, 6%, 56px)" }}>
                ...
                <div>
                  ...
                  {preview && <p style={{ fontFamily: "Georgia, serif", fontSize: "clamp(16px,4vw,22px)", color: "rgba(255,255,255,0.82)", lineHeight: 1.5, margin: "0 0 12px", display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{preview}</p>}
