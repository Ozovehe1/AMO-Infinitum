    ...
    <footer style={{ background: primary, borderTop: `1px solid ${accent}1f`, padding: "3rem 1.5rem 2rem" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: "2rem", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          {theme.twitterHandle && (
            <a href={`https://x.com/${theme.twitterHandle.replace("@", "")}`} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "0.4rem", color: "#8fa3b1", textDecoration: "none", fontFamily: "Inter, sans-serif", fontSize: "0.8rem", transition: "color 0.2s" }}>
